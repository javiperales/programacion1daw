...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Set <Coche> setCoches = new TreeSet <Coche>(); //crea set de coches
		
		List <Coche> listCoches = new LinkedList <Coche>(); //crea lista de coches 

		Coche coches[] = new Coche[3]; //crea array de 3 coches

		coches[0] = new Coche("001", 4, 2);//crea 3 objetos coche
		coches[1] = new Coche("004", 4, 4);
		coches[2] = new Coche("004", 4, 4);
		//////////////!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		File f = new File("ficheroCoches.dat"); // crea un nuevo fichero
		Fichero ficheroVariosObjetos; //objeto clase fichero
		if (f.exists()){
