...
public class Libreria {
	...
	static public String a_MuebleAzar(){
		Random azar= new Random();
		String MuebleAzar[]={"mesa","mesa salon", "mesilla de noche","cama pequeña","cama grande","cama mediana","cama matrimonio","litera","canape",
				"armario ropero","armario zapatero","armario pequeño","armario grande","mueble salon","estanteria rectangular","estanteria cuadrada",
				"estanteria bluj","mueble televsion","mueble despensa","mueble cocina","mueble baño","armario baño","tocador","escritorio","pupitre"};
		return MuebleAzar[azar.nextInt(MuebleAzar.length)];
	}
