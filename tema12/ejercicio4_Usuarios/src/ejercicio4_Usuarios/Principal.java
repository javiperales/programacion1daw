...
public class Principal {
	...
	public static void BorrarUsuario(String nombre, String contraseña, TreeMap<String, String> registro) {
		...
		contraseña = Libreria.t_pedirCadena(0, "contraseña del usuario");
		contraseña = codificar(contraseña);
		if (registro.containsKey(nombre) && registro.containsValue(contraseña)) {
	...
	public static Boolean claveValidar(String contraseña) {
		...
		for (int i = 0; i < contraseña.length(); i++) {
			if (!((contraseña.charAt(i) >= 'a' && contraseña.charAt(i) <= 'z')
					|| (contraseña.charAt(i) >= 'A' && contraseña.charAt(i) <= 'Z')
	...
	public static String descodificar(String contraseña) {
		char caracter;
		String claveAux = "";
		int num = 0;
		num = Leer.pedirEntero("grado de codificacion");
	...
	public static Boolean modificarClave(String nombre, String contraseña, TreeMap<String, String> registro,
			String claveNueva) {
		Boolean modificar = false;
		nombre = Libreria.t_pedirCadena(0, "nombre de usuario");
		contraseña = Libreria.t_pedirCadena(0, "contraseña vieja");
		if (registro.get(nombre).equals(codificar(contraseña))) {
