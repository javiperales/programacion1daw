 ...
 *
 */
public class Fecha implements Comparable<Fecha>, Serializable{//Necesario para poder comparar fechas y para guardar objetos en fichero
	private Integer dia;
	private Integer mes;
	...
	public String fechaTexto() {
		return this.dia + " de " + this.mesTexto() + " de " + this.anio;
	}
	/**
	...
	@Override
	public int compareTo(Fecha arg0) {//lo utilizarán para ordenar las colecciones que usenuna fecha como clave
		// TODO Auto-generated method stub
		return arg0.difFechas(this);
	}
