...
public class Fichero {
	...
	public List<Fruit> leerList( ) {
		List<Fruit> listaFrutas= new LinkedList<Fruit>();
		try {
			listaFrutas = (List<Fruit>) entrada.readObject();//leemos un registro
	...
	public Boolean escribirList(List<Fruit> listaCoches ){
