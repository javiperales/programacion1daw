...
public class Libreria {
	...
	public static void recorreTreeMapIntegerSS(TreeMap<String, Integer> mapa){ //cambiar tipo de dato del mapa que entra
		for(String i: mapa.keySet()){
			Integer valor = mapa.get(i);
			//hacer lo que sea con vada nodo aquí
	...
	public static void recorreTreeMapIntegerSTreeSet(TreeMap<Integer,TreeSet<String>> mapa){ //cambiar tipo de dato del mapa que entra
		for(Integer i: mapa.keySet()){
			TreeSet valor = mapa.get(i);
			
		}
	}
	
	public static void recorreTreeMapIntegerArrayList(TreeMap<Integer,ArrayList<String>> mapa){ //cambiar tipo de dato del mapa que entra
		for(Integer i: mapa.keySet()){
			ArrayList valor = mapa.get(i);
			
		}
	}
	
	public static void recorreTreeMapStringArrayList(TreeMap<String,ArrayList<String>> mapa){ //cambiar tipo de dato del mapa que entra
		for(String i: mapa.keySet()){
			ArrayList valor = mapa.get(i);
	...
	public static void recorreTreeMapStringArrayListInteger(TreeMap<String,ArrayList<Integer>> mapa){ //cambiar tipo de dato del mapa que entra
		for(String i: mapa.keySet()){
			ArrayList valor = mapa.get(i);
