...
public class Libreria {
	...
	static public String matriculaAzar() {
		Random azar= new Random();
		String matricula[]={"1907 FVD","1997 FYD","1907 SJD","1907 FMN","1907 FZV","1907 FVD","1945 FPS",
				"1912 FVD","1906 FSD","1937 FED","1657 FVD","1877 FCD","1920 FVD","1907 YTD","1785 FVD",
				"1901 FVD","1917 FVP","1904 FVP","1947 FVC","1907 FVR",};
		return matricula[azar.nextInt(matricula.length)];
	}
	static public String modeloAzar() {
		Random azar= new Random();
	String modelo[]={"Modelo1A", "Modelo2A", "Modelo3A", "Modelo4A", "Modelo5A", "Modelo6A",
			"Modelo1B", "Modelo2B", "Modelo3B", "Modelo4B", "Modelo5B", "Modelo6B"};
	return modelo[azar.nextInt(modelo.length)];
	}
	...
	static public String cocheAzar(){
		Random azar= new Random();
		...
		return marca[azar.nextInt(marca.length)];
	}
